...
const FileUploadForm = () => {
  ...
  const descriptions = {
    광고보고서: '광고 보고서를 업로드하세요. 여기에는 광고 클릭, 노출수, 광고비 등의 데이터가 포함됩니다.',
    판매내역: '판매 내역을 업로드하세요. 여기에는 날짜별 판매량, 총 매출액, 환불 데이터가 포함됩니다.',
    상품정보: '상품 정보를 업로드하세요. 여기에는 상품명, 옵션명, 가격 등의 데이터가 포함됩니다.',
  };
